...
class GetWeather12HourlyForecastUseCaseImpl(private val weather12HourlyForecastRepository: Weather12HourlyForecastRepository): GetWeather12HourlyForecastUseCase {
    override suspend fun invoke(locationKey: String): Result<MutableList<Weather12HourlyForecast>> = weather12HourlyForecastRepository.getWeather12HourlyForecastList(locationKey)
}